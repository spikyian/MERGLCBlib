 ...
 * 
 * # Application
 * The application provides the module specific functionality. MERGLCB provides
 * much of the standard functionality of MERGLCB modules. Different MERGLCB capabilities
 * are enabled through the use of MERGLCB services. For example CAN bus support
 * can be enabled by including the CAN service.
 * 
 * ## Application functionality
 * An MERGLCB module using this library needs to consider the following 
